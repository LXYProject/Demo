...
//    CGPoint point5 = CGPointMake(center.x, center.y - r);
    ...
    CGPoint point2 = CGPointMake(center.x - r*cos(M_PI/12), center.y+r*sin(M_PI/12));
    CGPoint point3 = CGPointMake(center.x - r*cos(M_PI * 3 / 7-M_PI/48), center.y - r*sin(M_PI * 4 / 4.5-M_PI/48));
...
//    [kWindow addSubview:menu5];
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        _menu4.alpha = 1;
        _menu5.alpha = 1;
        _menu1.center = point2;
        _menu2.center = point3;
