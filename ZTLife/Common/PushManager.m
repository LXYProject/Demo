...
- (void)pushToHomePage {
    ...
    CyhSliderVC *cyVc = [[CyhSliderVC alloc]init];
    cyVc.Leftvc = leftVc;
    cyVc.Mainvc = mainvc;
    AppDelegate *delegate = (AppDelegate *)[UIApplication sharedApplication].delegate;
    delegate.window.rootViewController = [[BaseNavigationController alloc]initWithRootViewController:cyVc];
}

//退出登录到登录页面
- (void)backLoginVc {
    AppDelegate *delegate = (AppDelegate *)[UIApplication sharedApplication].delegate;
    delegate.window.rootViewController = [[BaseNavigationController alloc]initWithRootViewController:[[LoginViewController alloc]init]];
}
@end
