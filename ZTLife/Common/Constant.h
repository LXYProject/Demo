...
//============================用户管理===========================================
// 获取同事列表
#define A_queryColleagueList    @"?service=PropertyColleague&function=queryColleagueList"



//============================物业公司人员请假服务===========================================
// 请假--请假或审批查询
#define A_queryApplyOrApprove  @"?service=PropertyLeave&function=queryApplyOrApprove"


//============================物业公司人员班次类型===========================================
// 排班计划--查
#define A_queryWorkPlan        @"?service=PropertyWorkPlan&function=queryWorkPlan"
// 班次类型--查
#define A_queryWorkShift       @"?service=PropertyWorkShift&function=queryWorkShift"


//============================物业公司内部人员的签到===========================================
// 获取签到签退令牌
#define A_getSignToken         @"?service=PropertySign&function=getSignToken"
// 签到
#define A_signIn               @"?service=PropertySign&function=signIn"
// 签退
#define A_signOut              @"?service=PropertySign&function=signOut"
