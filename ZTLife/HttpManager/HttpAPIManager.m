...
//    [newParamter setValue:@"20170607093552" forKey:@"userId"];
    ...
    [newParamter setValue:@"9/1bdgoGVIk9yCMJb9G2oA==" forKey:@"token"];
    [newParamter setValue:@"20170909150123" forKey:@"userId"];
...
- (id)dealWithParamterOne:(NSDictionary *)paramter{
    ...
    [newParamter setValue:@"9/1bdgoGVIk9yCMJb9G2oA==" forKey:@"userId"];
