...
{
    QZConditionFilterView *conditionFilter = [[QZConditionFilterView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 50)];
...
- (void)createSubView
{
    ...
    UILabel *bottomLine = [[UILabel alloc] initWithFrame:CGRectMake(0, 49.5, SCREEN_WIDTH, 0.5)];
...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        _filterTableView1 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 114, self.width, 0)];
        ...
        _filterTableView2 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 114, self.width, 0)];
        ...
        _filterTableView3 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 114, self.width, 0)];
